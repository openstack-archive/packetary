...
class SbuildDriver(PackagingDriverBase):
    ...
    def create_chroot(self, dist='trusty', mirror=None):
        ...
        try:
            stdout = self.sys_execute(create_chroot_command)
        except:
            raise ValueError('Failed to create chroot {1}'.format(dist))
    ...
    def add_apt_sources(self, chroot_name, mirror):
        ...
        try:
            ...
            raise ValueError('Failed to write apt sources.d file {0}'.format(

...
class TestRepositorySchemaBase(base.TestCase):
    def check_invalid_name(self):
        ...
        self.assertRaisesRegexp(
            ...
            jsonschema.validate, invalid_data['name'],
    ...
    def check_invalid_uri(self):
        ...
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "123 is not of type 'string'",
            jsonschema.validate, invalid_data['uri'],
            self.schema['properties']['uri']
        )
    ...
    def check_invalid_path(self):
        ...
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "123 is not of type 'string'",
            jsonschema.validate, invalid_data['path'],
            self.schema['properties']['path']
        )
    ...
    def check_required_properties(self):
        ...
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "'uri' is a required property",
            jsonschema.validate, repo_data1, self.schema
        )
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "'name' is a required property",
            jsonschema.validate, repo_data2, self.schema
        )
    ...
    def check_priority(self, min_value=None, max_value=None):
        if min_value is not None:
            self.assertRaisesRegexp(
                ...
                jsonschema.validate, min_value - 1,
                self.schema['properties']['priority']
            )
            self.assertNotRaises(
                jsonschema.ValidationError, jsonschema.validate, min_value,
                self.schema['properties']['priority']
            )
        if max_value is not None:
            self.assertRaisesRegexp(
                jsonschema.ValidationError,
                "is not valid under any of the given schemas",
                jsonschema.validate, max_value + 1,
                self.schema['properties']['priority']
            )
            self.assertNotRaises(
                jsonschema.ValidationError, jsonschema.validate, max_value,
                self.schema['properties']['priority']
            )
        self.assertNotRaises(
            jsonschema.ValidationError, jsonschema.validate, None,
            self.schema['properties']['priority']
        )
        self.assertRaisesRegexp(
            jsonschema.ValidationError,
            "'abc' is not valid under any of the given",
            jsonschema.validate, "abc", self.schema['properties']['priority']
        )
...
class TestPackagesSchema(base.TestCase):
    ...
    def test_validation_fail_for_required_properties(self):
        ...
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "'versions' is a required property",
            jsonschema.validate, requirements_data1, self.schema
        )
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "'name' is a required property",
            jsonschema.validate, requirements_data2, self.schema
        )
    ...
    def test_validation_fail_if_versions_is_invalid(self):
        ...
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "123 is not of type 'array'",
            jsonschema.validate, versions[0],
            self.schema['items']['properties']['versions']
        )
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "123 is not of type 'string'",
            jsonschema.validate, versions[1],
            self.schema['items']['properties']['versions']
        )
...
class TestPackageFilesSchema(base.TestCase):
    ...
    def test_validation_fail_if_invalid_file_urls(self):
        ...
        self.assertRaisesRegexp(
            ...
            jsonschema.validate, file_urls[0], self.schema
        )
        self.assertRaisesRegexp(
            jsonschema.ValidationError, "123 is not of type 'string'",
            jsonschema.validate, file_urls[1], self.schema
        )

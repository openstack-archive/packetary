...
from packetary.api import _loaders
...
class TestDataLoaders(base.TestCase):
    def test_load_filter(self):
        ...
        filters = _loaders.load_filters(filter_data)
        cases = [
        ...
        self.assertFalse(_loaders.load_filters([])(cases[0][1][0]))
    ...
    def test_load_package_relations(self):
        ...
        actual = []
        _loaders.load_package_relations(data, actual.append)
        self.assertItemsEqual(expected, actual)
        actual = []
        _loaders.load_package_relations(None, actual.append)
    ...
    def test_get_packages_traverse(self):
        ...
        actual = []
        traverse = _loaders.get_packages_traverse(
